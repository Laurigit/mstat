...
# input$select_martin_pakka <-1
  
ss_cols <- all_data[Omistaja == "Lauri" &
                      Pakka == input$select_laurin_pakka &
                      Vastustajan_Pakka == input$select_martin_pakka &
...
plot+ theme(legend.title=element_blank(),
            ...
            legend.background = element_rect(color = "black",
                                             fill = "transparent", size = 1, linetype = "solid")) + scale_x_continuous(name = "TurnausNo",
