...
RUN R -e "install.packages(c('doParallel', 'foreach'), repos='http://cran.rstudio.com/')"
...
#RUN R -e 'install.packages('http://cran.r-project.org/src/contrib/Archive/shinydashboardPlus/shinydashboardPlus_0.6.0.tar.gz", repos=NULL, type="source', method = 'libcurl')'

#install.packages("https://cran.r-project.org/src/contrib/Archive/shinydashboardPlus/shinydashboardPlus_0.6.0.tar.gz", repos=NULL, type="source")
